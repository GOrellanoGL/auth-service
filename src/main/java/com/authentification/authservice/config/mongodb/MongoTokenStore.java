package com.authentification.authservice.config.mongodb;

import com.authentification.authservice.domain.MongoAccessToken;
import com.authentification.authservice.domain.MongoRefreshToken;
